...
void CompareResult(vector<int>iresult, anl nresult){

	vector<int> nr;
	anl::iterator ai;
	//typedef map< pair<int, int>, vector<int> > anl;
	for (ai = nresult.begin(); ai != nresult.end(); ++ai){
		nr.insert(nr.end(), (*ai).second.begin(), (*ai).second.end());
	}
...
int main(){
	...
	string path = ".//data//T10I4D100K.dat";
	float fre = 0.005;
